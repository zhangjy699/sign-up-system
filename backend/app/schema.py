...
class ProfileCompletion(BaseModel):
    ...
    contact_number: str
    major: str
    full_english_name: str
    preferred_name: Optional[str] = None
    study_year: str

# Profile Update for completed profiles (using completion field names)
class CompletedProfileUpdate(BaseModel):
    full_english_name: Optional[str] = None
    preferred_name: Optional[str] = None
...
# Profile Response for completed profiles
class CompletedProfileResponse(BaseModel):
    full_english_name: str
    preferred_name: Optional[str] = None
    study_year: int
    major: str
